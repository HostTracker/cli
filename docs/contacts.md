...
## `ht-cli contacts bulk-delete`

Delete every contact a filter selects, as an asynchronous job.

```
ht-cli contacts bulk-delete [flags]
```
...
## `ht-cli contacts bulk-delete-validate`

Check which contacts a delete filter selects, without deleting anything.

```
ht-cli contacts bulk-delete-validate [flags]
```
...
## `ht-cli contacts bulk-validate`

Check what a contact batch would do, without writing anything.

```
ht-cli contacts bulk-validate [flags]
```
...
## `ht-cli contacts create-group`

Create a contact group.

```
ht-cli contacts create-group [flags]
```
...
## `ht-cli contacts delete-group`

Delete a contact group.

```
ht-cli contacts delete-group <id> [flags]
```
...
## `ht-cli contacts get-group`

Read one contact group.

```
ht-cli contacts get-group <id> [flags]
```
...
## `ht-cli contacts list-group`

List the account's contact groups.

```
ht-cli contacts list-group [flags]
```
...
## `ht-cli contacts resend-confirmation`

Resend the confirmation code for an unconfirmed contact.

```
ht-cli contacts resend-confirmation <id> [flags]
```
...
## `ht-cli contacts set-groups`

Set the contact groups one contact belongs to.

```
ht-cli contacts set-groups <id> [flags]
```
...
## `ht-cli contacts test`

Send a real test alert to a confirmed contact.

```
ht-cli contacts test <id> [flags]
```
...
## `ht-cli contacts update-group`

Change a contact group's name and/or replace its membership.

```
ht-cli contacts update-group <id> [flags]
```
...
## `ht-cli contacts verify`

Confirm a contact with the code it received.

```
ht-cli contacts verify <id> [flags]
```
