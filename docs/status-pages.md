...
## `ht status-pages add-incident-timeline-entry`

Append an entry to a declared incident's timeline.

```
ht status-pages add-incident-timeline-entry <id> <incident-id> [flags]
```
...
## `ht status-pages add-subscriber`

Add a push channel to a status page.

```
ht status-pages add-subscriber <id> [flags]
```
...
## `ht status-pages create`

Create a status page.

```
ht status-pages create [flags]
```
...
## `ht status-pages create-incident`

Declare an incident or a scheduled maintenance on a status page.

```
ht status-pages create-incident <id> [flags]
```
...
## `ht status-pages create-template`

Save an incident template.

```
ht status-pages create-template <id> [flags]
```
...
## `ht status-pages delete`

Delete a status page.

```
ht status-pages delete <id> [flags]
```
...
## `ht status-pages delete-incident`

Delete a declared incident.

```
ht status-pages delete-incident <id> <incident-id> [flags]
```
...
## `ht status-pages delete-subscriber`

Remove a subscriber from a status page.

```
ht status-pages delete-subscriber <id> <subscriber-id> [flags]
```
...
## `ht status-pages delete-template`

Delete an incident template.

```
ht status-pages delete-template <id> <template-id> [flags]
```
...
## `ht status-pages get-incident`

Read one declared incident with its full timeline.

```
ht status-pages get-incident <id> <incident-id> [flags]
```
...
## `ht status-pages list`

List the account's status pages.

```
ht status-pages list [flags]
```
...
## `ht status-pages list-incident`

List a status page's declared incidents.

```
ht status-pages list-incident <id> [flags]
```
...
## `ht status-pages list-subscriber`

List a status page's subscribers.

```
ht status-pages list-subscriber <id> [flags]
```
...
## `ht status-pages list-template`

List a status page's incident templates.

```
ht status-pages list-template <id> [flags]
```
...
## `ht status-pages set-components`

Replace a status page's whole component set.

```
ht status-pages set-components <id> [flags]
```
...
## `ht status-pages update`

Change a status page's title and/or settings.

```
ht status-pages update <id> [flags]
```
...
## `ht status-pages update-incident`

Fix a declared incident's title, kind or components; set its postmortem.

```
ht status-pages update-incident <id> <incident-id> [flags]
```
