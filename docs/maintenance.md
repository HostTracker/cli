...
## `ht-cli maintenance delete`

Cancel a maintenance window and receive a receipt.

```
ht-cli maintenance delete <id> [flags]
```
...
## `ht-cli maintenance get`

Read one maintenance window.

```
ht-cli maintenance get <id> [flags]
```
...
## `ht-cli maintenance list-monitor`

List the maintenance windows covering one monitor.

```
ht-cli maintenance list-monitor <monitor-id> [flags]
```
...
## `ht-cli maintenance update`

Reschedule a maintenance window or change what it covers.

```
ht-cli maintenance update <id> [flags]
```
