...
## `ht instant-checks create`

Start a one-off check against a url or host.

```
ht instant-checks create [flags]
```
...
## `ht instant-checks get`

Fetch the state and result of an instant check.

```
ht instant-checks get <db-id> <id> [flags]
```
...
## `ht instant-checks list`

List the account's past instant checks.

```
ht instant-checks list [flags]
```
...
## `ht instant-checks list-device`

List the device profiles a page-loading check can emulate.

```
ht instant-checks list-device [flags]
```
...
## `ht instant-checks list-type`

List the instant-check types and their options.

```
ht instant-checks list-type [flags]
```
